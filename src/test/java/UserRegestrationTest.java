...
public class UserRegestrationTest {
    static UserRegestration userRegistration = new UserRegestration();
    ...
    @Test
    public void givenEmailRerurnTrue(){
    ...
    @Test
    public void givenMobileNumberRerurnTrue(){
